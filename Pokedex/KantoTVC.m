...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    myListPath = [[self docsDir]stringByAppendingPathComponent:@"k.plist"];
    if(![[NSFileManager defaultManager]fileExistsAtPath:myListPath]){
        [[NSFileManager defaultManager]copyItemAtPath:[[NSBundle mainBundle] pathForResource:@"k" ofType:@"plist"] toPath:myListPath error:nil];
    }
